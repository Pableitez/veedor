// ========================================
// VEEDOR SIMPLE DASHBOARD - VERSIÓN FUNCIONAL
// ========================================

console.log('=== VEEDOR SIMPLE DASHBOARD INICIANDO ===');

// Función para crear datos de demo básicos
...
function updateFinancialSummary(transactions) {
    ...
    if (totalBalanceEl) {
        totalBalanceEl.textContent = `€${financialData.totalBalance.toFixed(2)}`;
    ...
    if (monthlyIncomeEl) {
        monthlyIncomeEl.textContent = `€${financialData.monthlyIncome.toFixed(2)}`;
    ...
    if (monthlyExpensesEl) {
        monthlyExpensesEl.textContent = `€${financialData.monthlyExpenses.toFixed(2)}`;
    ...
    if (monthlySavingsEl) {
        monthlySavingsEl.textContent = `€${financialData.monthlySavings.toFixed(2)}`;
...
console.log('=== VEEDOR SIMPLE DASHBOARD CARGADO ===');
