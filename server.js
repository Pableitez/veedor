...
// Acepta tanto MONGO_URI como MONGODB_URI para compatibilidad
...
// Solo agregamos /veedor si no hay ninguna base de datos especificada
if (MONGODB_URI && !MONGODB_URI.includes('mongodb://localhost')) {
    // Verificar si ya tiene una base de datos en la URI (después del último / y antes del ?)
